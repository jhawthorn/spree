    ...
    private
      ...
      def add_to_shipment(shipment, quantity)
        if variant.should_track_inventory?
          ...
          on_hand.times { shipment.set_up_inventory('on_hand', line_item) }
          back_order.times { shipment.set_up_inventory('backordered', line_item) }
        else
          quantity.times { shipment.set_up_inventory('on_hand', line_item) }
        end
      ...
      def remove_from_shipment(shipment, quantity)
        ...
        shipment_units = shipment.inventory_units_for_item(line_item).reject do |variant_unit|
